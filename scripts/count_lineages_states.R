...
# adding country and divsion columns
...
#                  "North Rhine Westphalia" = "DE_NW", "Rheinland-Pfalz" = "DE_RP", "Saarland" = "DE_SL", "Saxony" = "DE_SN",           #                  "Saxony-Anhalt" = "DE_ST", "Schleswig-Holstein" = "DE_SH", "Thuringia" = "DE_TH")
...
# rename column
names(gisaid_data_all)[which(names(gisaid_data_all) == "Pango lineage")] <- "pangolin_lineage"
