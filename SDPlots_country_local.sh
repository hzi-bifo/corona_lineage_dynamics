...
# build SD plot
Rscript $proj_folder/scripts/buildAD_sign.r $folder"/"$country $proj_folder/"scripts/" "false" 12 "png" $folder"/"$country".months.txt"
Rscript $proj_folder/scripts/buildAD_sign.r $folder"/"$country"_corrected" $proj_folder/"scripts/" "false" 12 "png" $folder"/"$country".months.txt" 
